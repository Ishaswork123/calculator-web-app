document.addEventListener("DOMContentLoaded", () => {
  ...
  function applyFunction(func) {
    ...
    // Save to history
    const calculation = `${func}(${currentOperand}) = ${result}`
  ...
  function getHistory() {
    const history = localStorage.getItem("scientificCalculatorHistory")
  ...
  functionButtons.forEach((button) => {
    button.addEventListener("click", () => {
      applyFunction(button.getAttribute("data-function"))
    })
  })
